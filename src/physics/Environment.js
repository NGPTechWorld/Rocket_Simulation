...
export default class Environment {
    ...
    getPressureAtAltitude(altitude) {
        ...
        if (T <= 0) return 0;
        const exponent = this.gravitationalAcceleration / (this.specificGasConstantAir * this.temperatureLapseRate);
        return this.seaLevelPressure * Math.pow(T / this.seaLevelTemperature, exponent);
    }
